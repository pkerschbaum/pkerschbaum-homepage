...
You can see a real-world example of how this tool was integrated into the `tiny-invariant` package in <FancyAnchor href="https://github.com/alexreardon/tiny-invariant/pull/164">this pull request</FancyAnchor>.
