...
- **Watch mode** for unit tests is not supported but there is some activity in the respective issue: <FancyAnchor href="https://github.com/microsoft/playwright/issues/21960">AUTOGENERATE</FancyAnchor>.  
