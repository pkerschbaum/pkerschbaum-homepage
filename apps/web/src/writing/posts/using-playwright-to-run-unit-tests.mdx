...
- **Watch mode** for "headless" mode of Playwright is not supported but there is some activity in the respective issue: <FancyAnchor href="https://github.com/microsoft/playwright/issues/21960">AUTOGENERATE</FancyAnchor>.  
  There are some workarounds in an old issue for watch mode: <FancyAnchor href="https://github.com/microsoft/playwright/issues/7035">AUTOGENERATE</FancyAnchor>.
