...
- <FancyAnchor href="https://ngrok.com/docs/getting-started/?os=linux">`ngrok`</FancyAnchor> is a great tool to expose a local server to the internet (e.g. to open the web application you work on on your mobile phone).
