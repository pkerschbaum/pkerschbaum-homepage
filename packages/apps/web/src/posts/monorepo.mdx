...
- **Autonomy of packages:** TSC/eslint/prettier can be configured per package; a package might not even use TypeScript
...
- let packages implement `dev` script which should start a watcher, e.g. `tsc --watch --preserveWatchOutput`
