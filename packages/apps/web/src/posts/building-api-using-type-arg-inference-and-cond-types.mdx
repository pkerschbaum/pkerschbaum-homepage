...
published: true
publishedAtISO: '2022-07-05T21:00:00.000Z'
description: A lesson on how to adapt the result type of a function call based on the actual arguments given.
shortenedURL: building-api-using-type-arg-inference-and-cond-types
tags: ['typescript', 'generics', 'conditionaltypes', 'webdev']
---
...
We will now incrementally improve that draft.
...
Still, you can see some similarities to our solution. It also inspects `include` and, if it is present and contains `orgUnit`, goes on with `OrgUnitGetPayload` (which contains, amongst other things, the properties for the `OrgUnit` model).  
If you are curious, you can clone <FancyAnchor href="https://github.com/pkerschbaum/building-api-using-type-arg-inference-and-cond-types_example/tree/main/prisma/lib/prisma-client">this repository I made</FancyAnchor> and dig through `index.d.ts`, the type definitions of Prisma Client (generated based on the schema we worked on in this blog post).
