...
A ready-to-use configuration can be found here: <FancyAnchor href="https://github.com/pkerschbaum/blog-playwright-for-unit-tests_example">AUTOGENERATE</FancyAnchor>.
