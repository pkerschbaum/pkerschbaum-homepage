...
description: Reasons for using Playwright Test as a test runner for unit tests, and how to fill in missing pieces (e.g. code coverage).
...
The following things are missing but can be filled by libraries from the Node.js ecosystem:
...
Unfortunately, some things are not supported and fixable:

- **Watch mode:** Not supported at the time of writing but "planned work": <FancyAnchor href="https://playwright.dev/docs/test-components#planned-work">AUTOGENERATE</FancyAnchor>.
